...
[
  "#{base}/rsakey_des3.pem",
  "#{base}/rsakey_aes128cbc.pem",
  "#{base}/private_key.pem",
  "#{base}/rsakey_des3.pub",
  "#{base}/rsakey_2.pub",
  "#{base}/eckey_prime256v1_des3.pem",
  "#{base}/eckey_prime256v1_des3.pub",
  "#{base}/eckey_prime256v1_des3_2.pub",
  "#{base}/dhparam.pem",
  "#{base}/mycert.crt",
  "#{base}/mycert.key",
  "#{base}/mycert2.crt",
  "#{base}/my_ca.crt",
  "#{base}/my_ca.key",
  "#{base}/my_signed_cert.crt",
  "#{base}/my_signed_cert.key",
  "#{base}/my_ca2.key",
  "#{base}/my_ca2.csr",
  "#{base}/my_ca2.crt",
  "#{base}/my_ca2.crl",
  "#{base}/my_signed_cert2.key",
  "#{base}/my_signed_cert2.csr",
  "#{base}/my_signed_cert2.crt",
  "#{base}/my_ec_request.csr",
  "#{base}/my_ec_request.key",
  "#{base}/my_ec_request2.csr",
  "#{base}/my_rsa_request.csr",
  "#{base}/my_rsa_request.key",
  "#{base}/my_rsa_request2.csr",
].each do |f|
